...
System.register(['aurelia-framework', 'aurelia-fetch-client'], function (_export, _context) {
  ...
  var inject, HttpClient, json, _createClass, _dec, _class, RandomCardView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('RandomCardView', RandomCardView = (_dec = inject(HttpClient), _dec(_class = function () {
        ...
        RandomCardView.prototype.progress = function progress(timeleft, timetotal, $element, cancel) {
